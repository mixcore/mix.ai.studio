...
const renewToken = () => tslib.__awaiter(void 0, void 0, void 0, function* () {
...
API.interceptors.response.use((response) => response, (error) => tslib.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
...
class CryptoService {
    ...
    encryptAES(message, iCompleteEncodedKey) {
        ...
        return CryptoJS__namespace.AES.encrypt(message, aesKeys.key, options).toString();
    }
    decryptAES(ciphertext, iCompleteEncodedKey) {
        ...
        const decrypted = CryptoJS__namespace.AES.decrypt(ciphertext, aesKeys.key, options);
        return decrypted.toString(CryptoJS__namespace.enc.Utf8);
    }
}
class AESKey {
    constructor(encryptedKeys) {
        const keyStrings = CryptoJS__namespace.enc.Utf8.stringify(CryptoJS__namespace.enc.Base64.parse(encryptedKeys)).split(',');
        this.iv = CryptoJS__namespace.enc.Base64.parse(keyStrings[0]);
        this.key = CryptoJS__namespace.enc.Base64.parse(keyStrings[1]);
    }
}
...
class MixcoreAuth {
    ...
    constructor(client) {
         ...
         * ```
         */
        this.login = (request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
         ...
         * ```
         */
        this.register = (userData, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.initUserData = (callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            const fetchUserProfile = () => tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        this.getUsers = (query, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
        ...
        this.updateUserProfile = (userData, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
        ...
        this.getUserProfileById = (userId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
        ...
        this.removeUserById = (userId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                // Fetch user profile by ID from the server
        ...
        this.changeUserPassword = (data, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         */
        this._handleAuthSuccess = (data) => tslib.__awaiter(this, void 0, void 0, function* () {
...
})(exports.ESearchMethod || (exports.ESearchMethod = {}));
/**
 * Enum representing different comparison operators for filtering data
 */
exports.ECompareOperator = void 0;
...
})(exports.ECompareOperator || (exports.ECompareOperator = {}));
/**
...
exports.EMixContentStatus = void 0;
...
})(exports.EMixContentStatus || (exports.EMixContentStatus = {}));
...
class MixQuery {
    ...
    searchByKeyword(keyword, searchColumns) {
        ...
        this.compareOperator = exports.ESearchMethod.Like;
        this.conjunction = "And";
        return this;
    }
    /**
    ...
    static Like(colName, value, isRequired = false) {
        return {
            value: value,
            fieldName: colName,
            compareOperator: exports.ECompareOperator.Like,
            isRequired,
        };
    }
    /**
    ...
    static Equal(colName, value, isRequired = false) {
        return {
            value: value,
            fieldName: colName,
            compareOperator: exports.ECompareOperator.Equal,
            isRequired,
        };
    }
    /**
    ...
    static Search(colName, value, isRequired = false) {
        return {
            value: value,
            fieldName: colName,
            compareOperator: exports.ECompareOperator.ILike,
            isRequired,
        };
    }
    /**
    ...
    static GreaterThan(colName, value, isRequired = false, isEquals = false) {
        return {
            ...
            compareOperator: isEquals
                ? exports.ECompareOperator.GreaterThanOrEqual
                : exports.ECompareOperator.GreaterThan,
            isRequired,
        };
    }
    /**
    ...
    static LessThan(colName, value, isRequired = false, isEquals = false) {
        return {
            ...
            fieldName: colName,
            compareOperator: isEquals
                ? exports.ECompareOperator.LessThanOrEqual
                : exports.ECompareOperator.LessThan,
            isRequired,
        };
    }
    /**
    ...
    static Includes(colName, value, isRequired) {
        return {
            ...
            fieldName: colName,
            compareOperator: exports.ECompareOperator.InRange,
            isRequired,
        };
    }
}
...
class MixcoreDatabase {
    constructor(client) {
        this.getDatabases = (query, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
        ...
        this.getMasterDatabaseTables = (callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         *
         */
        this.migrateToSingleTable = (dbSysName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         *
         */
        this.backupTable = (dbSysName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         *
         */
        this.restoreTable = (dbSysName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         *
         */
        this.updateDataTable = (dbSysName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
...
class MixcoreTable {
    ...
    constructor(client) {
         ...
         * ```
         */
        this.getDataByIds = (databaseName, request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.filterData = (databaseName, query, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.getNestedData = (databaseName, request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.exportData = (databaseName, request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.importData = (databaseName, request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.getDataById = (databaseName, id, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.getDataByColumn = (databaseName, columnName, columnValue, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.getDataByParent = (databaseName, parentType, parentId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.getDataByGuidParent = (databaseName, parentType, parentId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
                validateRequired(parentType, "parentType");
         ...
         * ```
         */
        this.createData = (databaseName, data, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
         ...
         * ```
         */
        this.updateData = (databaseName, id, data, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
                validateRequired(id, "id");
         ...
         * ```
         */
        this.deleteData = (databaseName, id, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
                validateRequired(id, "id");
         ...
         * ```
         */
        this.getDataRelationships = (databaseName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(databaseName);
        ...
        this.getTableInfoByName = (databaseSystemName, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
...
class MixcoreMixDBAssociation {
    ...
    constructor(client) {
         ...
         * ```
         */
        this.getAssociation = (parentDbName, childDbName, parentId, childId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.deleteAssociation = (parentDbName, childDbName, parentId, childId, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateDatabaseSystemName(parentDbName);
                validateDatabaseSystemName(childDbName);
         ...
         * ```
         */
        this.getAllAssociations = (request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.patchManyAssociations = (associations, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.createAssociation = (request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.getAssociationById = (id, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateRequired(id, 'id');
         ...
         * ```
         */
        this.deleteAssociationById = (id, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateRequired(id, 'id');
                const endpoint = `/rest/mix-portal/mix-db-association/${id}`;
         ...
         * ```
         */
        this.updateAssociationById = (id, updates, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateRequired(id, 'id');
         ...
         * ```
         */
        this.removeCacheById = (id, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateRequired(id, 'id');
         ...
         * ```
         */
        this.saveManyAssociations = (associations, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateRequired(associations, 'associations');
         ...
         * ```
         */
        this.filterAssociations = (request, callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                validateObject(request, 'request');
         ...
         * ```
         */
        this.getDefaultConfig = (callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
...
class MixcoreStorage {
    ...
    constructor(client) {
         ...
         * ```
         */
        this.uploadFile = (file_1, ...args_1) => tslib.__awaiter(this, [file_1, ...args_1], void 0, function* (file, folder = "MixContent/StaticFiles") {
        ...
        this.uploadFileBase64 = (request) => tslib.__awaiter(this, void 0, void 0, function* () {
         ...
         * ```
         */
        this.downloadFile = (filePath) => tslib.__awaiter(this, void 0, void 0, function* () {
            // Validate input parameters
         ...
         * ```
         */
        this.deleteFile = (filePath) => tslib.__awaiter(this, void 0, void 0, function* () {
            // Validate input parameters
            validateRequired(filePath, "filePath");
         ...
         * ```
         */
        this.getFileInfo = (filePath) => tslib.__awaiter(this, void 0, void 0, function* () {
            // Validate input parameters
            validateRequired(filePath, "filePath");
         ...
         * ```
         */
        this.listFiles = (...args_1) => tslib.__awaiter(this, [...args_1], void 0, function* (folder = "", page = 1, pageSize = 50) {
            // Validate input parameters
            if (page < 1) {
...
class MixcoreClient {
    ...
    constructor(config = {}) {
         ...
         * ```
         */
        this.getGlobalSetting = (callBack) => tslib.__awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
         ...
         * ```
         */
        this.initLocalization = () => tslib.__awaiter(this, void 0, void 0, function* () {
...
})(exports.EMixDatabaseProvider || (exports.EMixDatabaseProvider = {}));
exports.EMixDataType = void 0;
...
class MixColumn {
    constructor(data, configuration) {
        ...
        this.dataType = (_c = data.dataType) !== null && _c !== void 0 ? _c : exports.EMixDataType.Text;
...
class MixTable {
    constructor(value) {
        var _a, _b, _c;
        this.type = (_a = value.type) !== null && _a !== void 0 ? _a : exports.MixTableType.Service;
...
exports.DbContextFixId = DbContextFixId;
exports.ENDPOINTS = ENDPOINTS;
exports.MemoryStorageAdapter = MemoryStorageAdapter;
exports.MixColumn = MixColumn;
exports.MixQuery = MixQuery;
exports.MixTable = MixTable;
exports.MixcoreAuth = MixcoreAuth;
exports.MixcoreClient = MixcoreClient;
exports.MixcoreDatabase = MixcoreDatabase;
exports.MixcoreMixDBAssociation = MixcoreMixDBAssociation;
exports.MixcoreStorage = MixcoreStorage;
exports.MixcoreTable = MixcoreTable;
...
exports.defaultStorageAdapter = defaultStorageAdapter;
